...
import AdminCommonButton from "./AdminCommonButton";
...
import AdminCommonHeader from "./AdminCommonHeader";
    ...
    <div>
      ...
      {isAdminOpen && (
        <form
          ...
          className=" gap-6 bg-white   shadow-[0px_0px_1px_2px_rgba(0,0,0,.04)] rounded-xl p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 h-full"
        >
