    ...
    <div className="fixed inset-0 bg-opacity-50 backdrop-blur-sm transition-opacity flex items-center justify-center p-2 sm:p-4 md:p-6 overflow-y-auto md:mt-10 min-h-screen">
      <div className="bg-[#EAF7E6] rounded-lg w-full max-w-md relative my-4 sm:my-8 ">
        ...
        <div className="p-3 sm:p-4 md:p-6">
          <h2 className="text-lg sm:text-xl font-bold text-[#758179] mb-4 sm:mb-6">
            CONFIRM PAYMENT
          </h2>
          ...
          <div className="space-y-3 sm:space-y-4">
              ...
              <label className="flex items-start gap-2 sm:gap-3">
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-center flex-wrap gap-2">
                    <span className="text-sm sm:text-base md:text-lg text-[#758179]">
                  ...
                  {paymentMethod === "card" && (
                    <div className="mt-3 sm:mt-4 space-y-3 sm:space-y-4">
                      <div>
                        <label className="text-sm sm:text-base md:text-lg text-[#758179]">
                          Card Holder Name
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="relative">
                        ...
                        <img
                          src={visaCard}
                          alt=""
                          className="absolute top-8 sm:top-9 right-2 sm:right-3 h-5 sm:h-7"
                        />
                      </div>
                      ...
                      <div className="md:flex gap-2">
                        ...
                        <div className="w-[25%] flex items-center justify-center gap-1 sm:gap-2 pt-4">
                          ...
                          <h3 className="text-xs sm:text-sm text-[#758179]">
                            3 Digit
                          </h3>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <span className="text-xs sm:text-sm text-[#758179]">
                          I have carefully read and accepted the Terms &
                          Conditions.
                        </span>
                      </div>
                      ...
                      <button
                        ...
                        className="w-full bg-[#2DAD00] text-white py-2 sm:py-3 rounded-md hover:bg-green-600 transition-colors text-sm sm:text-base"
                      >
                        Pay Now
                      </button>
                    </div>
            ...
            <div className="border rounded-lg p-3 sm:p-4 border-[#E7E9E8]">
              <label className="flex items-center gap-2 sm:gap-3">
                ...
                />
                <div className="flex-1">
                  <h2 className="text-sm sm:text-base md:text-lg text-[#758179]">
                    Online Bank Service
                  </h2>
                  <h4 className="text-xs sm:text-sm text-[#9DA6A0]">
                    Transcription fee may apply
                  </h4>
                </div>
