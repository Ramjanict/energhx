...
const RoomOverView = () => {
  const { energyAudit, getEnergyAudit, isLoading } = useConsumerStore();
  ...
  if (isLoading || !energyAudit || energyAudit.length === 0) {
    return (
      <div>
        <h2>The request analysis did not give any response</h2>
      </div>
    ...
    <>
      <div className="flex flex-col gap-10">
        ...
        <div>
          ...
          />
          <h2 className="text-primary-gray text-2xl">
