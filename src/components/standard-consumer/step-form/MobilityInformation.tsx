...
interface MobilityInformation {
  direction: string;
  length: number;
  width: number;
}
const MobilityInformation: React.FC<MobilityInformation> = ({
  direction,
  length,
  width,
}) => {
  return (
    <div className=" max-w-80 text-accent">
...
export default MobilityInformation;
