...
const AllUserBuilding = () => {
  //   const [buildings, setBuildings] = useState<BuildingType[]>([]);
  const { buildings, setBuildings, setSelectedBuilding } = useBuildingStore();
  ...
  console.log("All User Buildings: ", buildings);

  const handleSubmit = (building: BuildingType) => {
    setSelectedBuilding(building);
    console.log("Selected Building: ", building);
    navigate(
      `/standard-consumer/buildingInformation/allBuildings/${building.building_type?.building_type_id}`
    );
    // setStep(9);
  };
  return (
...
export default AllUserBuilding;
