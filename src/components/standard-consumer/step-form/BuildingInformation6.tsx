...
const BuildingInformation6: React.FC<ContinueButtonType> = ({
  nextStep,
  prevStep,
}) => {
  ...
  return (
    <div>
      <div>
        ...
        <div className=" max-w-xl pb-10 text-lg">
          {buildingInfo.map((item) => (
            <div className=" grid grid-cols-2 text-[14px] sm:text-lg">
              <div>
        ...
        <div className="pb-10">
          ...
          <input
            className="  max-w-64 outline-none  rounded-xs border border-[#9DA6A0] p-2 "
            type="text"
